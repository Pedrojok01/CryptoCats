...
export const CAT_ABI: Abi = [
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: "address", name: "owner", type: "address" },
      { indexed: true, internalType: "uint256", name: "catId", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "dadId", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "mumId", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "genes", type: "uint256" },
    ],
    name: "Birth",
    type: "event",
  },
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_dadId", type: "uint256" },
      { internalType: "uint256", name: "_mumId", type: "uint256" },
    ],
    name: "breed",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    stateMutability: "nonpayable",
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint32", name: "dadId", type: "uint32" },
      { internalType: "uint32", name: "mumId", type: "uint32" },
      { internalType: "uint64", name: "birthTime", type: "uint64" },
  ...
  {
    inputs: [{ internalType: "uint256", name: "_genes", type: "uint256" }],
    name: "createCatGen0",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "dadId", type: "uint256" },
      { internalType: "uint256", name: "mumId", type: "uint256" },
